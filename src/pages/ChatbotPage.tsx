      ...
      const response = await fetch('https://models.inference.ai.azure.com/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a helpful assistant that analyzes job descriptions and matching resumes. Provide insights about why these resumes are good matches and what makes them suitable for the role.',
            },
            {
              role: 'user',
              content: `Job Description: ${jobDescription}\n\nI found ${matchingResumes.length} matching resumes. Please provide a brief analysis of why these resumes might be good matches for this job description.`,
            },
          ],
          max_tokens: 500,
          temperature: 0.7,
